...
# 增加逻辑删除字段
ALTER TABLE `user` ADD COLUMN `is_deleted` tinyint(1) DEFAULT 0 COMMENT '是否删除 0未删除 1已删除';
...
INSERT INTO `item_config` (id, type, img, `describe`) VALUES (1, 1, NULL, '用户可以使用改名卡，更改自己的名字。badboychat名称全局唯一，快抢订你的专属昵称吧');
INSERT INTO `item_config` (id, type, img, `describe`) VALUES (2, 2, 'https://cdn-icons-png.flaticon.com/128/1533/1533913.png', '爆赞徽章，单条消息被点赞超过10次，即可获得');
INSERT INTO `item_config` (id, type, img, `describe`) VALUES (3, 2, 'https://cdn-icons-png.flaticon.com/512/6198/6198527.png ', '不良聊天系统前10名注册的用户才能获得的专属徽章');
INSERT INTO `item_config` (id, type, img, `describe`) VALUES (4, 2, 'https://cdn-icons-png.flaticon.com/512/10232/10232583.png', '不良聊天系统前100名注册的用户才能获得的专属徽章');
INSERT INTO `item_config` (id, type, img, `describe`) VALUES (5,2, 'https://cdn-icons-png.flaticon.com/128/2909/2909937.png', '不良聊天系统成员的专属徽章');
INSERT INTO `item_config` (id, type, img, `describe`) VALUES (6, 2, 'https://minio.mallchat.cn/mallchat/%E8%B4%A1%E7%8C%AE%E8%80%85.png', '不良聊天项目contributor专属徽章');
