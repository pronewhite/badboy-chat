package com.hitsz.badboyChat.common.service.cache;
...
public abstract class AbstractRedisStringCache<IN, OUT> implements BatchCache<IN, OUT> {
    ...
    public Map<IN, OUT> getBatch(List<IN> req) {
        ...
        //批量get
        List<OUT> valueList = RedisCommonProcessor.mget(keys, outClass);
        //差集计算
        ...
        if (CollectionUtil.isNotEmpty(loadReqs)) {
            ...
            RedisCommonProcessor.mset(loadMap, getExpireSeconds());
        }
