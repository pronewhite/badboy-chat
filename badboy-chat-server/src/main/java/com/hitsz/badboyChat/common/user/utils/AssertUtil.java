...
import com.hitsz.badboyChat.common.exception.ExceptionResponseEnum;
...
public class AssertUtil {
    ...
    public static <T> void fastFailValidate(T obj) {
        ...
        if (constraintViolations.size() > 0) {
            throwException(ExceptionResponseEnum.PARAM_INVALID, constraintViolations.iterator().next().getMessage());
        }
    }
